...
class RelatorioInseriveis extends StatefulWidget {
  RelatorioInseriveis({Key? key}) : super(key: key);

  @override
  State<RelatorioInseriveis> createState() => _RelatorioInseriveisState();
}

class _RelatorioInseriveisState extends State<RelatorioInseriveis> {
  @override
  void initState() {
    super.initState();
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            relatorioController.creatPdf(
                                listPatrimonio, 'Bens inserviveis');
                          },
                          child: Container(
                            width: 200,
                            height: 50,
  ...
  relatorioInserviveis() async {
    ...
    homeController.listLevantamento.forEach((levantamento) {
      if (levantamento.Status == 'INSERVIVEL') {
